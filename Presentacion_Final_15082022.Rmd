...
```{r Video_Uso_Github, results='asis'}
...
https://rpubs.com/jachimi/Proyecto_Final_R_RM_G_GH_18082022

### ***Link de acceso repositorio en Github:***

![Repositorio](logo_github.png){width="15%"}
https://github.com/jachimi/proyecto_final_r_rm_g_gh_18082022.git
